...
app.use(cors({
    origin: process.env.NODE_ENV === 'production' ? 'https://papers-please-front.onrender.com' : 'http://localhost:3000',
    credentials: true
}));
...
app.use(session({
    ...
    cookie: {
        httpOnly: true,
        domain: process.env.NODE_ENV === 'production' ? 'https://papers-please-front.onrender.com' : null,
